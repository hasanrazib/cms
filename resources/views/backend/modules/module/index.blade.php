    ...
    <div class="row">
        <div class="col-xl-4">
            <div class="page-title-box">
                ...
                <a href="{{url('modules/create')}}" class="btn btn-primary btn-sm">Add New</a>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        @forelse($modules as $key => $module)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('modules.edit',$module)}}" class="btn btn-info sm rh-btn" title="Edit Data">  <i class="fas fa-edit"></i> </a>
